"""
Apply low-pass filtering to all audio files in data/audio/.
...
def main():
    ...
    parser.add_argument("--cutoff",       type=float, default=4000.0, help="Low-pass cutoff frequency in Hz (e.g. 8000, 4000, 2000, 1000).")
    ...
    out_dir = args.out_dir or os.path.join(PROJECT_DIR, "data", f"audio_lowpass_{cutoff_label}Hz")
